...
setup(name='pudzu-utils', version=VERSION, py_modules=['pudzu.utils'],
...
setup(name='pudzu-dates', version=VERSION, py_modules=['pudzu.dates'],
...
setup(name='pudzu-pillar', version=VERSION, py_modules=['pudzu.pillar'],
...
setup(name='pudzu-charts', version=VERSION, py_modules=['pudzu.charts'],
